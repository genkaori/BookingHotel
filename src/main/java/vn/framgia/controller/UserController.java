...
/*	@RequestMapping(value = "/newUser", method = RequestMethod.POST)
    ...
    */
	...
	public ModelAndView showListUsers() {
		...
		if (listUser == null){
			System.out.println("list null: "+listUser.size());
    ...
    public ModelAndView editUser(@RequestParam int id){
    	...
    	System.out.println(userBean.getId()+" , "+userBean.getFullname());
    ...
    public ModelAndView updateUser(@ModelAttribute(value = "userForm") UserBean userBean){
    	boolean check = true;
